...
const data = [
  ...
  },
  {
    ...
    title: "What is the resignation rate at different performance levels?",
    subTitle:
      "The performance level with highest resignation rate is Low Performer at 18.4%.",
  },
  {
    img: orgTenure,
    title: "What is the tenure of people who resign?",
    subTitle:
      "The tenure with highest average resignation rate is <b> 1 to 2 years </b> at <b> 14.77%.<b>",
  },
  {
    img: driverResign,
    title: "What employee attributes lead to a higher resignation rate?",
    subTitle:
      "the biggest factors leading to an increased resignation rate are <b> Employee Span of Control Range  0 </b> and <b> Employee Job Family Individual contributor 2 <b>",
  },
  {
    img: employeeRiskOfExit,
    title: "Who has the highest predicted likelihood of resigning next?",
    subTitle:
      "The employee with highest risk of resigning is <b> Varinia Melissa Haley </b> at <b> 45.2%.<b> The role most at risk of resigning is <b> Plant Operator. </b>",
  },
  {
    img: resignation250,
    title: "How much talent is predicted to resign in next 12 months?",
    subTitle:
      " <b> 539 employees <b> are predicted to resign in the next 12 months, <b>39.15%</b> of these from within the <b> Operations organization.</b>",
  },
];
...
function App() {
  ...
  return (
    <>
      <Header expandAllClick={expandAllClick} expandAll={expandAll} />
      <Sidebar />
